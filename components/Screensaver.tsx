...
// Re-incorporating the animated title as requested in a previous step
const AnimatedTitle = () => {
    ...
    return (
        ...
        >
            <div className="text-center p-8 bg-black/20 backdrop-blur-md rounded-2xl shadow-2xl border border-white/10">
                <h1 className="text-6xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-sky-400">
                    SC-Dashboard
                </h1>
            </div>
        </motion.div>
