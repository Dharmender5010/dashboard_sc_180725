...
//
// 6. UPDATE FRONTEND: Paste the copied URL into the `WEB_APP_URL` constants in `services/helpService.ts`, `services/otpService.ts`, and `services/activityService.ts`.
//
